...
Cday.data.processed <- read.csv("raw_data/cday_120_clean_gross.csv") # Unit gC d-1 # (with varying alpha)
...
sigma.data.processed <- read.csv("raw_data/M_leafarea_model_prev.csv") # Unitless
